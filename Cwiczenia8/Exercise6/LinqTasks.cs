...
namespace Exercise6
{
    public static class LinqTasks
    {
        ...
        {
            IEnumerable<Emp> result = Emps.Where((x) => x.Job == "Frontend programmer" && x.Salary > 1000)
        ...
        public static IEnumerable<Dept> Task14()
        {
            IEnumerable<Dept> result = Depts
                .GroupJoin(
                    ...
                    d => d.Deptno,
                    e => e.Deptno,
                    (d, eGroup) => new { Department = d, EmployeeCount = eGroup.Count() }
                )
                .Where(de => de.EmployeeCount == 5 || de.EmployeeCount == 0)
